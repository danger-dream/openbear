...
<style>
.reference-inspector-head{display:flex;align-items:center;gap:10px;padding:11px 12px;border-bottom:1px solid var(--ob-border)}.reference-inspector-head>button{margin-left:auto;border:0;background:none;color:inherit;font-size:18px;padding:0 3px}.reference-inspector-scope{display:flex;gap:8px;align-items:center;padding:9px 12px;font-size:11px}.reference-inspector-scope select,.reference-inspector-scope input{color:inherit;background:transparent;border:1px solid var(--ob-border-strong);border-radius:5px;font:inherit;padding:3px 5px}.reference-inspector-scope input{width:55px}.reference-inspector-meta{font-size:10px;color:var(--ob-text-subtle);padding:7px 12px}.reference-inspector-content{margin:0;padding:4px 12px 12px;overflow:auto;white-space:pre-wrap;word-break:break-word;font-family:inherit;font-size:12px;line-height:1.65}.reference-inspector-empty{padding:20px 12px;text-align:center;color:var(--ob-text-subtle)}.reference-inspector-empty.is-error{color:var(--ob-danger)}.reference-inspector-sensitive{padding:10px 12px 17px;color:var(--ob-warning);font-size:12px;line-height:1.7}
</style>
