...
class WebAdminAppMixin:
    ...
    def make_app(self) -> web.Application:
        ...
        app.add_routes([
            ...
            web.get("/api/mcp/oauth/status/{server}", self.handle_api_mcp_oauth_status),
            web.post("/api/mcp/oauth/authorize/{server}", self.handle_api_mcp_oauth_authorize),
            web.post("/api/mcp/oauth/revoke/{server}", self.handle_api_mcp_oauth_revoke),
            web.get("/api/mcp/oauth/callback/{server}", self.handle_api_mcp_oauth_callback),
