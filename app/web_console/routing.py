    ...
    def make_app(self) -> web.Application:
        ...
        app.add_routes([
            ...
            *(web.get(path, self.handle_pwa_asset) for path in PWA_PUBLIC_FILES),
            ...
            web.get("/api/conversation-tree/bootstrap", self.handle_api_conversation_tree_bootstrap),
            web.get("/api/conversation-tree/children", self.handle_api_conversation_tree_children),
            web.get("/api/conversation-tree/search", self.handle_api_conversation_tree_search),
            web.get("/api/conversation-tree/status", self.handle_api_conversation_tree_status),
            web.post("/api/conversation-tree/read", self.handle_api_conversation_activity_read),
            web.get("/api/conversation-tree/folders", self.handle_api_conversation_tree_folders),
            web.get("/api/conversation-tree/locate-folder/{folder_uuid}", self.handle_api_conversation_tree_folder_locate),
            web.get("/api/conversation-tree/locate/{conversation_uuid}", self.handle_api_conversation_tree_locate),
            web.post("/api/conversation-tree/move/impact", self.handle_api_conversation_tree_move_impact),
            web.post("/api/conversation-tree/move", self.handle_api_conversation_tree_move),
            web.post("/api/conversation-folders", self.handle_api_conversation_folder_create),
            web.patch("/api/conversation-folders/{folder_uuid}", self.handle_api_conversation_folder_patch),
            web.get("/api/conversation-folders/{folder_uuid}/properties", self.handle_api_conversation_folder_properties),
            web.post("/api/conversation-folders/{folder_uuid}/properties/impact", self.handle_api_conversation_folder_properties_impact),
            web.put("/api/conversation-folders/{folder_uuid}/properties", self.handle_api_conversation_folder_properties_update),
            ...
            web.post("/api/conversations/{conversation_uuid}/uploads", self.handle_api_upload_create),
            web.put("/api/conversations/{conversation_uuid}/uploads/{upload_uuid}", self.handle_api_upload_chunk),
            web.post("/api/conversations/{conversation_uuid}/uploads/{upload_uuid}/complete", self.handle_api_upload_complete),
            web.delete("/api/conversations/{conversation_uuid}/uploads/{upload_uuid}", self.handle_api_upload_delete),
            ...
            web.post("/api/conversations/{conversation_uuid}/retry/now", self.handle_api_conversation_retry_now),
            ...
            web.post("/api/conversations/{conversation_uuid}/title/generate", self.handle_api_conversation_title_generate),
            ...
            web.post("/api/conversations/{conversation_uuid}/context-strategy", self.handle_api_conversation_context_strategy),
            ...
            web.get("/api/statistics", self.handle_api_statistics),
            ...
            web.post("/api/settings/browser/test", self.handle_api_browser_connection_test),
